...
# The following step is not needed inside the Dockerfile since 'git lfs pull' should be run on the repo outside of Docker.
# If you want to ensure LFS files are present, run 'git lfs pull' on your host before building the image.
